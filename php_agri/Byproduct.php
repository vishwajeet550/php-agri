...
<head>
    ...
    <title>Byproducts | Post Harvest Management</title>
...
<body>
    ...
    <div class="data2">
            ...
            <div class="b1">
                <p>&emsp; &emsp; Byproducts are generally secondary products derived 
                    from primary agro-food production processes and represent an interesting 
                    and cheaper source of potentially functional ingredients, such as peptides, 
                    carotenoids, and phenolic compounds, thus promoting a circular economy concept. 
                    it is not the primary product or service being produced.
                    Lignocellulosic agricultural byproducts are a copious and cheap source for 
                    cellulose fibers. Byproducts produced from the cultivation of corn, wheat, rice, 
                    sorghum, barley, sugarcane, pineapple, banana and coconut are the major sources 
                    of agro-based biofibers.<br>
                    </p><br>
            </div>
            <br>
                ...
                <div class="blockback1">
                    ...
                    <div class="block1">
                        ...
                        <a href="Grapes-By.php" class="btn"> Grapes</a>
                    </div>
                </div>
                <div class="tag2">
                ...
                <div class="blockback2">
                    <div class="block2">
                        ...
                        <a href="Wheat-By.php" class="btn"> Wheat</a>
                    </div>
                ...
                <div class="blockback3">
                    <div class="block3">
                        ...
                        <a href="Cotton-By.php" class="btn"> Cotton</a>
                    </div>
                ...
                <div class="blockback4">
                    ...
                    <div class="block4">
                        ...
                        <a href="Coconut-By.php" class="btn"> Coconut</a>
                    </div>
                </div>
